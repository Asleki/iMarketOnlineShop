...
// It also includes the image gallery, quantity selector, and related products section.
//
...
document.addEventListener('DOMContentLoaded', async () => {
        ...
        const infoHtml = `
            <div class="product-info-column">
                ...
                <div class="shipping-info">
                    <i class="fas fa-truck-fast"></i> ${product.isFreeShipping ? 'Free Shipping' : `Shipping: ${product.shipping} (${product.waitingPeriod})`}
                </div>
                ...
                <div class="color-options">
                    ...
                    ${product.availableColors.map(color => `
                        <span class="color-box" style="background-color: ${color.toLowerCase()};" title="${color}"></span>
                    `).join('')}
                </div>` : ''}
                ...
                <div class="quantity-selector-container">
                    ...
                    <div class="quantity-selector">
                        <button id="quantity-decrease-btn">-</button>
                        <input type="number" id="quantity-input" value="1" min="${product.minOrderQuantity}" max="${product.maxOrderQuantity}">
                        <button id="quantity-increase-btn">+</button>
                    </div>
                </div>
    ...
    function setupEventListeners(product) {
        ...
        const decreaseBtn = document.getElementById('quantity-decrease-btn');
        const increaseBtn = document.getElementById('quantity-increase-btn');
        ...
        if (quantityInput) {
            quantityInput.addEventListener('change', () => {
                ...
                if (value > product.maxOrderQuantity) {
